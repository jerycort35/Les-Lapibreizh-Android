...
internal class ImagesReferenceLayout(context: Context) : ViewGroup(context) {
    ...
    private val art by lazy { BitmapFactory.decodeResource(resources, R.drawable.images_master_art) }
    ...
    fun label(text: String, size: Float = 26f, color: Int = Color.WHITE, centered: Boolean = false): TextView = TextView(context).apply {
        this.text = text; setTextColor(color); typeface = Typeface.create("serif",Typeface.NORMAL)
    ...
    override fun onMeasure(widthMeasureSpec:Int,heightMeasureSpec:Int) {
        ...
        unit=minOf(w/864f,h/1458f); logicalHeight=h/unit
